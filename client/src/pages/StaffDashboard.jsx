                    ...
                    <div className="shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg overflow-x-auto">
                        <table className="min-w-full divide-y divide-gray-300" style={{ minWidth: '700px' }}>
                            <thead className="bg-gray-50">
                                <tr>
                                    <th className="w-full py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Name</th>
                                    <th className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Roll No</th>
                                    <th className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 hidden sm:table-cell">Department</th>
                                ...
                                {students.map((student) => (
                                    <tr key={student._id}>
                                        <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">
                                            {student.name}
                                            <span className="block sm:hidden text-xs text-gray-500">{student.department}</span>
                                        </td>
                                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{student.rollNumber}</td>
                                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500 hidden sm:table-cell">{student.department}</td>
